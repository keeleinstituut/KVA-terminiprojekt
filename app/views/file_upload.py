        ...
        if self.pdf_input.value:
            ...
            if status == -1:
                self.alert_pane.param.update(
                    object="Sellise pealkirjaga fail on juba baasis olemas!",
                    visible=True,
                )
        else:
